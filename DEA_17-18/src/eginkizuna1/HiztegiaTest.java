...
import org.junit.After;
 ...
 @Test
 	public void testEragiketaSinpleak() {
 		...
 		if(!hiztegia.word2Webs("e").contains(web.getUrl())) fail("Ez da ondo gehitu"); //word2Webren froga bat da ere
 	}
 @Test
 ...
 @Test
 	public void testDatuakKargatu(){
 		...
 		hiztegia.datuakKargatu("src\\eginkizuna1\\fitxategiHutsa.txt");
 		
 		System.out.println("\n>DatuakKargatu (Lista Laburra)");
 		hiztegia.datuakKargatu("src\\eginkizuna1\\hiztegiLaburra.txt");
