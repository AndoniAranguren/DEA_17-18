 ...
 public class WebOrriaTest {
	...
	private static WebOrria w1,w2;
 	...
 	public void testWebOrria() {
 		...
 		System.out.println("\n1.Sartutako ida: "+id1+" Emaitza: "+w1.getUrl());
 		if(w1.getId()!=id1) fail("Ida ezberdina");
 		System.out.println("Sartutako urla: "+url1+" Emaitza: "+w1.getUrl());
 		if(w1.getUrl()!=url1) fail("Urla ezberdina");
 		System.out.println("Lortutako gakoak: "+ w1.getGakoa());
 		
 
 		System.out.println("\n2.Sartutako ida: "+id2+" Emaitza: "+w2.getUrl());
 		if(w2.getId()!=id2) fail("Ida ezberdina");
 		System.out.println("Sartutako urla: "+url2+" Emaitza: "+w2.getUrl());
 		if(w2.getUrl()!=url2) fail("Urla ezberdina");
