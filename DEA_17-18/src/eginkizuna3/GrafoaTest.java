...
// 		String a1="0-00.pl";	//A web that links to a2
// 		String a2="0-24.ro";	//A web that is linked by a1
// 		String a3="0033worldnavi.com";	//A web that doesn't link to anybody
// 		String a4="zbp.pl"; //A web linked to a1
// 		String a5="sypialniamarzen.net";
// 		
// 		Assert.assertNotNull(grafoa.erlazionatutaPath(a1, a5));	//Linkeatuta daukan web batera
// 		//Assert.assertNull(grafoa.erlazionatutaPath(a3, a2));	//Ez linkeatuta daukan web batera
// 		Assert.assertEquals(grafoa.erlazionatutaPath(a1, a1).toString(),"["+a1+"]");	//Bere burura
// 		
// 		WebOrriZerrenda.getWebOrriZerrenda().clear();
...
//
//		Stopwatch watch= new Stopwatch();
// 		WebOrriZerrenda.getWebOrriZerrenda().erlazionatuta(a1, a5);
//		System.out.println("\nWebOrri: "+watch.elapsedTime()+" "+ WebOrriZerrenda.getWebOrriZerrenda().erlazionatutaPath(a1, a5).toString());
// 	
//
//		watch= new Stopwatch();
// 		grafoa.erlazionatutaPath(a1, a5);
//		System.out.println("\nGrafo: "+watch.elapsedTime()+" "+ grafoa.erlazionatutaPath(a1, a5).toString());
//	}
